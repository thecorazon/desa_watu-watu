...
<div class="col-sm-8" style="margin-top:50px;">
    <div class="bg-secondary rounded h-100 p-4">
        <h5 class="mb-4">About Slider Update Form</h5>
        <form method="post" enctype="multipart/form-data">
            @csrf
            <div class="row mb-3">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Photo</label>
                <div class="col-sm-10">
                    <input type="hidden" class="form-control" name="hiddenfile" value="{{$result->Photo}}" id="inputEmail3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="Position" value="{{$result->Position}}" id="inputEmail3" placeholder="Position">
                    @error('Position')
                    <p style="color:red;">{{$message}}</p>
                    @enderror
                </div>
